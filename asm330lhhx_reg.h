 ...
 */
int32_t asm330lhhx_read_reg(const stmdev_ctx_t *ctx, uint8_t reg,
                            uint8_t *data,
                            uint16_t len);
int32_t asm330lhhx_write_reg(const stmdev_ctx_t *ctx, uint8_t reg,
                             uint8_t *data,
                             uint16_t len);
...
typedef enum
{
  ...
  ASM330LHHX_LP_ODR_DIV_100            = 0x84,
  ASM330LHHX_LP_ODR_DIV_200            = 0x85,
  ASM330LHHX_LP_ODR_DIV_400            = 0x86,
  ASM330LHHX_LP_ODR_DIV_800            = 0x87,
...
int32_t asm330lhhx_wkup_threshold_get(const stmdev_ctx_t *ctx,
                                      uint8_t *val);
...
int32_t asm330lhhx_fifo_watermark_set(const stmdev_ctx_t *ctx,
                                      uint16_t val);
...
typedef enum
{
  ...
  ASM330LHHX_TEMP_BATCHED_AT_1Hz6    = 1,
  ASM330LHHX_TEMP_BATCHED_AT_12Hz5   = 2,
  ASM330LHHX_TEMP_BATCHED_AT_52Hz    = 3,
...
int32_t asm330lhhx_fifo_full_flag_get(const stmdev_ctx_t *ctx,
                                      uint8_t *val);
...
typedef enum
{
  ...
  ASM330LHHX_STAMP_IN_XL_DATA     = 2,
  ASM330LHHX_STAMP_IN_GY_XL_DATA  = 1,
...
int32_t asm330lhhx_den_mark_axis_x_set(const stmdev_ctx_t *ctx,
                                       uint8_t val);
int32_t asm330lhhx_den_mark_axis_x_get(const stmdev_ctx_t *ctx,
                                       uint8_t *val);

int32_t asm330lhhx_den_mark_axis_y_set(const stmdev_ctx_t *ctx,
                                       uint8_t val);
int32_t asm330lhhx_den_mark_axis_y_get(const stmdev_ctx_t *ctx,
                                       uint8_t *val);

int32_t asm330lhhx_den_mark_axis_z_set(const stmdev_ctx_t *ctx,
                                       uint8_t val);
...
int32_t asm330lhhx_mag_soft_iron_set(const stmdev_ctx_t *ctx,
                                     const uint16_t *val);
int32_t asm330lhhx_mag_soft_iron_get(const stmdev_ctx_t *ctx,
                                     uint16_t *val);
...
typedef enum
{
  ASM330LHHX_INTERNAL_PULL_UP_OFF = 0,
  ASM330LHHX_INTERNAL_PULL_UP_ON  = 1,
...
int32_t asm330lhhx_sh_pass_through_set(const stmdev_ctx_t *ctx,
                                       uint8_t val);
...
typedef enum
{
  ASM330LHHX_EXT_ON_INT2_PIN = 1,
  ASM330LHHX_XL_GY_DRDY      = 0,

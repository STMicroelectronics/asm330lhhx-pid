...
/**
  ...
  *
  */
int32_t __weak asm330lhhx_read_reg(const stmdev_ctx_t *ctx, uint8_t reg,
                                   uint8_t *data,
                                   uint16_t len)
{
  int32_t ret = 0;
...
/**
  ...
  *
  */
int32_t __weak asm330lhhx_write_reg(const stmdev_ctx_t *ctx, uint8_t reg,
                                    uint8_t *data,
                                    uint16_t len)
{
  int32_t ret = 0;
...
{
  asm330lhhx_ctrl1_xl_t ctrl1_xl = {0};
  int32_t ret = 0;

  ret = asm330lhhx_read_reg(ctx, ASM330LHHX_CTRL1_XL,
                            (uint8_t *)&ctrl1_xl, 1);
                                    ...
                                    asm330lhhx_odr_xl_t val)
{
  ...
  asm330lhhx_emb_fsm_enable_t fsm_enable = {0};
  asm330lhhx_fsm_odr_t fsm_odr = {0};
  uint8_t mlc_enable = 0;
  asm330lhhx_mlc_odr_t mlc_odr = {0};
  asm330lhhx_ctrl1_xl_t ctrl1_xl = {0};
  int32_t ret = 0;
      ...
      if (ret == 0)
      {
        switch (fsm_odr)
        {
          case ASM330LHHX_ODR_FSM_12Hz5:
            if (odr_xl == ASM330LHHX_XL_ODR_OFF)
            {
          ...
          case ASM330LHHX_ODR_FSM_26Hz:
            ...
            else if (odr_xl == ASM330LHHX_XL_ODR_12Hz5)
            {
              odr_xl = ASM330LHHX_XL_ODR_26Hz;
            }
            else
          ...
          case ASM330LHHX_ODR_FSM_52Hz:
            ...
            else if (odr_xl == ASM330LHHX_XL_ODR_26Hz)
            {
              odr_xl = ASM330LHHX_XL_ODR_52Hz;
            }
            else
          ...
          case ASM330LHHX_ODR_FSM_104Hz:
            ...
            else if (odr_xl == ASM330LHHX_XL_ODR_52Hz)
            {
              odr_xl = ASM330LHHX_XL_ODR_104Hz;
            }
            else
...
{
  asm330lhhx_ctrl2_g_t ctrl2_g = {0};
  int32_t ret = 0;
  ret = asm330lhhx_read_reg(ctx, ASM330LHHX_CTRL2_G,
                            (uint8_t *)&ctrl2_g, 1);

  if (ret == 0)
  {
    ctrl2_g.fs_g = (uint8_t)(val & 0x0F);
    ret = asm330lhhx_write_reg(ctx, ASM330LHHX_CTRL2_G,
                               (uint8_t *)&ctrl2_g, 1);
  }
  ...
  if (ret == 0)
  {
         ...
         fsm_enable.fsm_enable_b.fsm16_en) == PROPERTY_ENABLE)
    {
      ...
      if (ret == 0)
      {
        ...
        {
          case ASM330LHHX_ODR_FSM_12Hz5:
            if (odr_gy == ASM330LHHX_GY_ODR_OFF)
            {
          ...
          case ASM330LHHX_ODR_FSM_26Hz:
            ...
            else if (odr_gy == ASM330LHHX_GY_ODR_12Hz5)
            {
              odr_gy = ASM330LHHX_GY_ODR_26Hz;
            }
            else
          ...
          case ASM330LHHX_ODR_FSM_52Hz:
            ...
            else if (odr_gy == ASM330LHHX_GY_ODR_26Hz)
            {
              odr_gy = ASM330LHHX_GY_ODR_52Hz;
            }
            else
          ...
          case ASM330LHHX_ODR_FSM_104Hz:
            ...
            else if (odr_gy == ASM330LHHX_GY_ODR_52Hz)
            {
              odr_gy = ASM330LHHX_GY_ODR_104Hz;
            }
            else
...
/**
  ...
  *
  */
int32_t asm330lhhx_block_data_update_set(const stmdev_ctx_t *ctx,
                                         uint8_t val)
{
  asm330lhhx_ctrl3_c_t ctrl3_c = {0};
  int32_t ret = {0};
  ret = asm330lhhx_read_reg(ctx, ASM330LHHX_CTRL3_C,
                            (uint8_t *)&ctrl3_c, 1);

  if (ret == 0)
  {
    ctrl3_c.bdu = (uint8_t)val & 0x01U;
    ret = asm330lhhx_write_reg(ctx, ASM330LHHX_CTRL3_C,
                               (uint8_t *)&ctrl3_c, 1);
  }
...
/**
  ...
  *
  */
int32_t asm330lhhx_block_data_update_get(const stmdev_ctx_t *ctx,
                                         uint8_t *val)
{
  asm330lhhx_ctrl3_c_t ctrl3_c = {0};
  int32_t ret = {0};
...
{
  asm330lhhx_ctrl6_c_t ctrl6_c = {0};
  int32_t ret = {0};
  ret = asm330lhhx_read_reg(ctx, ASM330LHHX_CTRL6_C,
                            (uint8_t *)&ctrl6_c, 1);

  if (ret == 0)
  {
    ctrl6_c.usr_off_w = (uint8_t)val & 0x01U;
    ret = asm330lhhx_write_reg(ctx, ASM330LHHX_CTRL6_C,
                               (uint8_t *)&ctrl6_c, 1);
  }
...
{
  asm330lhhx_ctrl7_g_t ctrl7_g = {0};
  int32_t ret = {0};
  ret = asm330lhhx_read_reg(ctx, ASM330LHHX_CTRL7_G,
                            (uint8_t *)&ctrl7_g, 1);

  if (ret == 0)
  {
    ctrl7_g.g_hm_mode = (uint8_t)val & 0x01U;
    ret = asm330lhhx_write_reg(ctx, ASM330LHHX_CTRL7_G,
                               (uint8_t *)&ctrl7_g, 1);
  }
                                   ...
                                   asm330lhhx_all_sources_t *val)
{
  ...
  if (ret == 0)
  {
    ret = asm330lhhx_read_reg(ctx, ASM330LHHX_MLC_STATUS_MAINPAGE,
...
/**
  ...
  *
  */
int32_t asm330lhhx_xl_flag_data_ready_get(const stmdev_ctx_t *ctx,
                                          uint8_t *val)
{
  asm330lhhx_status_reg_t status_reg = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_gy_flag_data_ready_get(const stmdev_ctx_t *ctx,
                                          uint8_t *val)
{
  asm330lhhx_status_reg_t status_reg = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_temp_flag_data_ready_get(const stmdev_ctx_t *ctx,
                                            uint8_t *val)
{
  asm330lhhx_status_reg_t status_reg = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_xl_usr_offset_x_set(const stmdev_ctx_t *ctx,
                                       int8_t *val)
{
  int32_t ret = {0};

  ret = asm330lhhx_write_reg(ctx, ASM330LHHX_X_OFS_USR, (uint8_t *)val, 1);
...
/**
  ...
  *
  */
int32_t asm330lhhx_xl_usr_offset_x_get(const stmdev_ctx_t *ctx,
                                       int8_t *val)
{
  int32_t ret = {0};

  ret = asm330lhhx_read_reg(ctx, ASM330LHHX_X_OFS_USR, (uint8_t *)val, 1);
...
/**
  ...
  *
  */
int32_t asm330lhhx_xl_usr_offset_y_set(const stmdev_ctx_t *ctx,
                                       int8_t *val)
{
  int32_t ret = {0};

  ret = asm330lhhx_write_reg(ctx, ASM330LHHX_Y_OFS_USR, (uint8_t *)val, 1);
...
/**
  ...
  *
  */
int32_t asm330lhhx_xl_usr_offset_y_get(const stmdev_ctx_t *ctx,
                                       int8_t *val)
{
  int32_t ret = {0};

  ret = asm330lhhx_read_reg(ctx, ASM330LHHX_Y_OFS_USR, (uint8_t *)val, 1);
...
/**
  ...
  *
  */
int32_t asm330lhhx_xl_usr_offset_z_set(const stmdev_ctx_t *ctx,
                                       int8_t *val)
{
  int32_t ret = {0};

  ret = asm330lhhx_write_reg(ctx, ASM330LHHX_Z_OFS_USR, (uint8_t *)val, 1);
...
/**
  ...
  *
  */
int32_t asm330lhhx_xl_usr_offset_z_get(const stmdev_ctx_t *ctx,
                                       int8_t *val)
{
  int32_t ret = {0};

  ret = asm330lhhx_read_reg(ctx, ASM330LHHX_Z_OFS_USR, (uint8_t *)val, 1);
...
{
  asm330lhhx_ctrl10_c_t ctrl10_c = {0};
  int32_t ret = {0};

  ret = asm330lhhx_read_reg(ctx, ASM330LHHX_CTRL10_C,
                            (uint8_t *)&ctrl10_c, 1);
...
{
  asm330lhhx_ctrl5_c_t ctrl5_c = {0};
  int32_t ret = {0};

  ret = asm330lhhx_read_reg(ctx, ASM330LHHX_CTRL5_C,
                            (uint8_t *)&ctrl5_c, 1);

  if (ret == 0)
  {
    ctrl5_c.rounding = (uint8_t)val & 0x03U;
    ret = asm330lhhx_write_reg(ctx, ASM330LHHX_CTRL5_C,
                               (uint8_t *)&ctrl5_c, 1);
  }
...
/**
  ...
  *
  */
int32_t asm330lhhx_temperature_raw_get(const stmdev_ctx_t *ctx,
                                       int16_t *val)
{
  uint8_t buff[2] = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_angular_rate_raw_get(const stmdev_ctx_t *ctx,
                                        int16_t *val)
{
  uint8_t buff[6] = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_acceleration_raw_get(const stmdev_ctx_t *ctx,
                                        int16_t *val)
{
  uint8_t buff[6] = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_odr_cal_reg_set(const stmdev_ctx_t *ctx, int8_t val)
{
  asm330lhhx_internal_freq_fine_t internal_freq_fine = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_odr_cal_reg_get(const stmdev_ctx_t *ctx, int8_t *val)
{
  asm330lhhx_internal_freq_fine_t internal_freq_fine = {0};
  int32_t ret = {0};
...
{
  asm330lhhx_func_cfg_access_t func_cfg_access = {0};
  int32_t ret = {0};
...
int32_t asm330lhhx_ln_pg_write_byte(const stmdev_ctx_t *ctx, uint16_t add,
                                    uint8_t *val)
{
  return asm330lhhx_ln_pg_write(ctx, add, val, 1);
}
...
{
  asm330lhhx_page_rw_t page_rw = {0};
  asm330lhhx_page_sel_t page_sel = {0};
  asm330lhhx_page_address_t page_address = {0};
  uint8_t msb = {0};
  uint8_t lsb = {0};
  int32_t ret = {0};
  uint8_t i = {0};
  ...
  /* set page write */
  ret = asm330lhhx_read_reg(ctx, ASM330LHHX_PAGE_RW,
                            (uint8_t *)&page_rw, 1);
  if (ret != 0)
  {
    goto exit;
  ...
  ret = asm330lhhx_write_reg(ctx, ASM330LHHX_PAGE_RW,
                             (uint8_t *)&page_rw, 1);
                                   ...
                                   uint8_t *val)
{
  ...
  /* read value */
  ret = asm330lhhx_read_reg(ctx, ASM330LHHX_PAGE_VALUE, val, 1);
  if (ret != 0)
  {
    goto exit;
  }
...
{
  asm330lhhx_counter_bdr_reg1_t counter_bdr_reg1 = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_device_id_get(const stmdev_ctx_t *ctx, uint8_t *val)
{
  int32_t ret = {0};

  ret = asm330lhhx_read_reg(ctx, ASM330LHHX_WHO_AM_I, val, 1);
...
{
  asm330lhhx_ctrl4_c_t ctrl4_c = {0};
  int32_t ret = {0};

  ret = asm330lhhx_read_reg(ctx, ASM330LHHX_CTRL4_C,
                            (uint8_t *)&ctrl4_c, 1);

  if (ret == 0)
  {
    ctrl4_c.lpf1_sel_g = (uint8_t)val & 0x01U;
    ret = asm330lhhx_write_reg(ctx, ASM330LHHX_CTRL4_C,
                               (uint8_t *)&ctrl4_c, 1);
  }
...
/**
  ...
  *
  */
int32_t asm330lhhx_drdy_mask_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  asm330lhhx_ctrl4_c_t ctrl4_c = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_drdy_mask_get(const stmdev_ctx_t *ctx, uint8_t *val)
{
  asm330lhhx_ctrl4_c_t ctrl4_c = {0};
  int32_t ret = {0};
...
{
  asm330lhhx_ctrl8_xl_t ctrl8_xl = {0};
  int32_t ret = {0};

  ret = asm330lhhx_read_reg(ctx, ASM330LHHX_CTRL8_XL,
                            (uint8_t *)&ctrl8_xl, 1);
                                         ...
                                         asm330lhhx_hp_slope_xl_en_t *val)
{
  ...
  else
  {
    ...
    {
      case 0x00:
        *val = is_low_pass == 1u ? ASM330LHHX_LP_ODR_DIV_4 : ASM330LHHX_SLOPE_ODR_DIV_4;
        break;

      case 0x01:
        *val = is_low_pass == 1u ? ASM330LHHX_LP_ODR_DIV_10 : ASM330LHHX_HP_ODR_DIV_10;
        break;

      case 0x02:
        *val = is_low_pass == 1u ? ASM330LHHX_LP_ODR_DIV_20 : ASM330LHHX_HP_ODR_DIV_20;
        break;

      case 0x03:
        *val = is_low_pass == 1u ? ASM330LHHX_LP_ODR_DIV_45 : ASM330LHHX_HP_ODR_DIV_45;
        break;

      case 0x04:
        *val = is_low_pass == 1u ? ASM330LHHX_LP_ODR_DIV_100 : ASM330LHHX_HP_ODR_DIV_100;
        break;

      case 0x05:
        *val = is_low_pass == 1u ? ASM330LHHX_LP_ODR_DIV_200 : ASM330LHHX_HP_ODR_DIV_200;
        break;

      case 0x06:
        *val = is_low_pass == 1u ? ASM330LHHX_LP_ODR_DIV_400 : ASM330LHHX_HP_ODR_DIV_400;
        break;
...
/**
  ...
  *
  */
int32_t asm330lhhx_xl_fast_settling_set(const stmdev_ctx_t *ctx,
                                        uint8_t val)
{
  asm330lhhx_ctrl8_xl_t ctrl8_xl = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_xl_fast_settling_get(const stmdev_ctx_t *ctx,
                                        uint8_t *val)
{
  asm330lhhx_ctrl8_xl_t ctrl8_xl = {0};
  int32_t ret = {0};
...
{
  asm330lhhx_int_cfg0_t int_cfg0 = {0};
  int32_t ret = {0};
...
/**
  * @defgroup   ASM330LHHX_ main_serial_interface
...
{
  asm330lhhx_pin_ctrl_t pin_ctrl = {0};
  int32_t ret = {0};

  ret = asm330lhhx_read_reg(ctx, ASM330LHHX_PIN_CTRL,
                            (uint8_t *)&pin_ctrl, 1);

  if (ret == 0)
  {
    pin_ctrl.sdo_pu_en = (uint8_t)val & 0x01U;
    ret = asm330lhhx_write_reg(ctx, ASM330LHHX_PIN_CTRL,
                               (uint8_t *)&pin_ctrl, 1);
  }
...
{
  asm330lhhx_i3c_bus_avb_t i3c_bus_avb = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_spi_mode_set(const stmdev_ctx_t *ctx,
                                asm330lhhx_sim_t val)
{
  asm330lhhx_ctrl3_c_t ctrl3_c = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_spi_mode_get(const stmdev_ctx_t *ctx,
                                asm330lhhx_sim_t *val)
{
  asm330lhhx_ctrl3_c_t ctrl3_c = {0};
  int32_t ret = {0};
...
{
  asm330lhhx_ctrl9_xl_t ctrl9_xl = {0};
  asm330lhhx_i3c_bus_avb_t i3c_bus_avb = {0};
  int32_t ret = {0};
...
{
  asm330lhhx_pin_int2_route_t pin_int2_route = {0};
  asm330lhhx_int_cfg1_t int_cfg1 = {0};
  int32_t ret = {0};
...
{
  asm330lhhx_pin_int1_route_t pin_int1_route = {0};
  asm330lhhx_int_cfg1_t int_cfg1 = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_pin_mode_set(const stmdev_ctx_t *ctx,
                                asm330lhhx_pp_od_t val)
{
  asm330lhhx_ctrl3_c_t ctrl3_c = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_pin_mode_get(const stmdev_ctx_t *ctx,
                                asm330lhhx_pp_od_t *val)
{
  asm330lhhx_ctrl3_c_t ctrl3_c = {0};
  int32_t ret = {0};
...
{
  asm330lhhx_wake_up_dur_t wake_up_dur = {0};
  int32_t ret = {0};
...
{
  asm330lhhx_wake_up_ths_t wake_up_ths = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_xl_usr_offset_on_wkup_set(const stmdev_ctx_t *ctx,
                                             uint8_t val)
{
  asm330lhhx_wake_up_ths_t wake_up_ths = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_act_mode_set(const stmdev_ctx_t *ctx,
...
{
  asm330lhhx_free_fall_t free_fall = {0};
  int32_t ret = {0};
...
{
  asm330lhhx_fifo_ctrl1_t fifo_ctrl1 = {0};
  asm330lhhx_fifo_ctrl2_t fifo_ctrl2 = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_fifo_watermark_get(const stmdev_ctx_t *ctx,
                                      uint16_t *val)
{
  asm330lhhx_fifo_ctrl1_t fifo_ctrl1 = {0};
  asm330lhhx_fifo_ctrl2_t fifo_ctrl2 = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_fifo_stop_on_wtm_set(const stmdev_ctx_t *ctx,
                                        uint8_t val)
{
  asm330lhhx_fifo_ctrl2_t fifo_ctrl2 = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_fifo_stop_on_wtm_get(const stmdev_ctx_t *ctx,
                                        uint8_t *val)
{
  asm330lhhx_fifo_ctrl2_t fifo_ctrl2 = {0};
  int32_t ret = {0};
...
{
  asm330lhhx_fifo_ctrl3_t fifo_ctrl3 = {0};
  int32_t ret = {0};
...
{
  asm330lhhx_fifo_ctrl4_t fifo_ctrl4 = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_rst_batch_counter_set(const stmdev_ctx_t *ctx,
                                         uint8_t val)
{
  asm330lhhx_counter_bdr_reg1_t counter_bdr_reg1 = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_rst_batch_counter_get(const stmdev_ctx_t *ctx,
                                         uint8_t *val)
{
  asm330lhhx_counter_bdr_reg1_t counter_bdr_reg1 = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_batch_counter_threshold_set(const stmdev_ctx_t *ctx,
                                               uint16_t val)
{
  asm330lhhx_counter_bdr_reg2_t counter_bdr_reg1 = {0};
  asm330lhhx_counter_bdr_reg2_t counter_bdr_reg2 = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_fifo_data_level_get(const stmdev_ctx_t *ctx,
                                       uint16_t *val)
{
  uint8_t reg[2] = {0};
...
{
  asm330lhhx_fifo_data_out_tag_t fifo_data_out_tag = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_sh_batch_slave_0_set(const stmdev_ctx_t *ctx,
                                        uint8_t val)
{
  asm330lhhx_slv0_config_t slv0_config = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_sh_batch_slave_0_get(const stmdev_ctx_t *ctx,
                                        uint8_t *val)
{
  asm330lhhx_slv0_config_t slv0_config = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_sh_batch_slave_1_set(const stmdev_ctx_t *ctx,
                                        uint8_t val)
{
  asm330lhhx_slv1_config_t slv1_config = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_sh_batch_slave_1_get(const stmdev_ctx_t *ctx,
                                        uint8_t *val)
{
  asm330lhhx_slv1_config_t slv1_config = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_sh_batch_slave_2_set(const stmdev_ctx_t *ctx,
                                        uint8_t val)
{
  asm330lhhx_slv2_config_t slv2_config = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_sh_batch_slave_2_get(const stmdev_ctx_t *ctx,
                                        uint8_t *val)
{
  asm330lhhx_slv2_config_t slv2_config = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_sh_batch_slave_3_set(const stmdev_ctx_t *ctx,
                                        uint8_t val)
{
  asm330lhhx_slv3_config_t slv3_config = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_sh_batch_slave_3_get(const stmdev_ctx_t *ctx,
                                        uint8_t *val)
{
  asm330lhhx_slv3_config_t slv3_config = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_den_mode_set(const stmdev_ctx_t *ctx,
                                    ...
                                    asm330lhhx_den_lh_t val)
{
  ...
  ret = asm330lhhx_read_reg(ctx, ASM330LHHX_CTRL9_XL,
                            (uint8_t *)&ctrl9_xl, 1);
...
/**
  ...
  *
  */
int32_t asm330lhhx_den_mark_axis_x_get(const stmdev_ctx_t *ctx,
                                       uint8_t *val)
{
  asm330lhhx_ctrl9_xl_t ctrl9_xl = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_den_mark_axis_y_get(const stmdev_ctx_t *ctx,
                                       uint8_t *val)
{
  asm330lhhx_ctrl9_xl_t ctrl9_xl = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_den_mark_axis_z_get(const stmdev_ctx_t *ctx,
                                       uint8_t *val)
{
  asm330lhhx_ctrl9_xl_t ctrl9_xl = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_mag_sensitivity_set(const stmdev_ctx_t *ctx,
                                       uint16_t val)
{
  uint8_t buff[2] = {0};
  int32_t ret = {0};
  ...
  ret = asm330lhhx_ln_pg_write_byte(ctx, ASM330LHHX_MAG_SENSITIVITY_L,
                                    &buff[0]);

  if (ret == 0)
  {
    ret = asm330lhhx_ln_pg_write_byte(ctx, ASM330LHHX_MAG_SENSITIVITY_H,
                                      &buff[1]);
  }
...
/**
  ...
  *
  */
int32_t asm330lhhx_mag_sensitivity_get(const stmdev_ctx_t *ctx,
                                       uint16_t *val)
{
  uint8_t buff[2] = {0};
  int32_t ret = {0};

  ret = asm330lhhx_ln_pg_read_byte(ctx, ASM330LHHX_MAG_SENSITIVITY_L,
                                   &buff[0]);

  ret += asm330lhhx_ln_pg_read_byte(ctx, ASM330LHHX_MAG_SENSITIVITY_H,
                                    &buff[1]);
  if (ret != 0)
  {
    return ret;
...
/**
  ...
  *
  */
int32_t asm330lhhx_mag_offset_set(const stmdev_ctx_t *ctx, const int16_t *val)
{
  uint8_t buff[6] = {0};
  int32_t ret = {0};
  uint8_t i = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_mag_soft_iron_set(const stmdev_ctx_t *ctx, const uint16_t *val)
{
  uint8_t buff[12] = {0};
  int32_t ret = {0};
  uint8_t i = 0x00U;
  ...
  ret = asm330lhhx_ln_pg_write_byte(ctx, ASM330LHHX_MAG_SI_XX_L,
                                    &buff[i]);

  if (ret == 0)
  {
    i++;
    ret = asm330lhhx_ln_pg_write_byte(ctx, ASM330LHHX_MAG_SI_XX_H,
                                      &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhx_ln_pg_write_byte(ctx, ASM330LHHX_MAG_SI_XY_L,
                                      &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhx_ln_pg_write_byte(ctx, ASM330LHHX_MAG_SI_XY_H,
                                      &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhx_ln_pg_write_byte(ctx, ASM330LHHX_MAG_SI_XZ_L,
                                      &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhx_ln_pg_write_byte(ctx, ASM330LHHX_MAG_SI_XZ_H,
                                      &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhx_ln_pg_write_byte(ctx, ASM330LHHX_MAG_SI_YY_L,
                                      &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhx_ln_pg_write_byte(ctx, ASM330LHHX_MAG_SI_YY_H,
                                      &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhx_ln_pg_write_byte(ctx, ASM330LHHX_MAG_SI_YZ_L,
                                      &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhx_ln_pg_write_byte(ctx, ASM330LHHX_MAG_SI_YZ_H,
                                      &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhx_ln_pg_write_byte(ctx, ASM330LHHX_MAG_SI_ZZ_L,
                                      &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhx_ln_pg_write_byte(ctx, ASM330LHHX_MAG_SI_ZZ_H,
                                      &buff[i]);
  }
...
int32_t asm330lhhx_mag_soft_iron_get(const stmdev_ctx_t *ctx, uint16_t *val)
{
  ...
  ret = asm330lhhx_ln_pg_read_byte(ctx, ASM330LHHX_MAG_SI_XX_L,
                                   &buff[i]);

  if (ret == 0)
  {
    i++;
    ret = asm330lhhx_ln_pg_read_byte(ctx, ASM330LHHX_MAG_SI_XX_H,
                                     &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhx_ln_pg_read_byte(ctx, ASM330LHHX_MAG_SI_XY_L,
                                     &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhx_ln_pg_read_byte(ctx, ASM330LHHX_MAG_SI_XY_H,
                                     &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhx_ln_pg_read_byte(ctx, ASM330LHHX_MAG_SI_XZ_L,
                                     &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhx_ln_pg_read_byte(ctx, ASM330LHHX_MAG_SI_XZ_H,
                                     &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhx_ln_pg_read_byte(ctx, ASM330LHHX_MAG_SI_YY_L,
                                     &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhx_ln_pg_read_byte(ctx, ASM330LHHX_MAG_SI_YY_H,
                                     &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhx_ln_pg_read_byte(ctx, ASM330LHHX_MAG_SI_YZ_L,
                                     &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhx_ln_pg_read_byte(ctx, ASM330LHHX_MAG_SI_YZ_H,
                                     &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhx_ln_pg_read_byte(ctx, ASM330LHHX_MAG_SI_ZZ_L,
                                     &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhx_ln_pg_read_byte(ctx, ASM330LHHX_MAG_SI_ZZ_H,
                                     &buff[i]);
  }
  ...
  if (ret == 0)
  {
    ...
    val[3] = (uint16_t)(buff[6] | ((uint16_t)buff[7] << 8));
    val[4] = (uint16_t)(buff[8] | ((uint16_t)buff[9] << 8));
    val[5] = (uint16_t)(buff[10] | ((uint16_t)buff[11] << 8));
...
{
  asm330lhhx_mag_cfg_a_t mag_cfg_a = {0};
  int32_t ret = {0};
  ...
  if (ret == 0)
  {
    mag_cfg_a.mag_z_axis = (uint8_t)val & 0x07U;
                                    ...
                                    asm330lhhx_mag_y_axis_t val)
{
  ...
  if (ret == 0)
  {
    mag_cfg_a.mag_y_axis = (uint8_t)val & 0x07U;
    ret = asm330lhhx_ln_pg_write_byte(ctx, ASM330LHHX_MAG_CFG_A,
                                      (uint8_t *)&mag_cfg_a);
  }
...
{
  asm330lhhx_mag_cfg_b_t mag_cfg_b = {0};
  int32_t ret = {0};
  ...
  if (ret == 0)
  {
    mag_cfg_b.mag_x_axis = (uint8_t)val & 0x07U;
...
{
  asm330lhhx_fsm_status_a_mainpage_t status_a = {0};
  asm330lhhx_fsm_status_b_mainpage_t status_b = {0};
  int32_t ret = {0};
...
int32_t asm330lhhx_long_cnt_flag_data_ready_get(const stmdev_ctx_t *ctx,
                                                uint8_t *val)
{
  asm330lhhx_emb_func_status_t emb_func_status = {0};
  int32_t ret = {0};
...
{
  int32_t ret = {0};
  asm330lhhx_emb_func_en_b_t emb_func_en_b = {0};
...
int32_t asm330lhhx_long_cnt_set(const stmdev_ctx_t *ctx, uint16_t val)
{
  ...
  if (ret == 0)
  {
    ret = asm330lhhx_write_reg(ctx, ASM330LHHX_FSM_LONG_COUNTER_L, buff,
                               2);
  }
...
int32_t asm330lhhx_long_cnt_get(const stmdev_ctx_t *ctx, uint16_t *val)
{
  ...
  if (ret == 0)
  {
    ret = asm330lhhx_read_reg(ctx, ASM330LHHX_FSM_LONG_COUNTER_L, buff,
                              2);
    if (ret == 0)
    {
...
{
  asm330lhhx_fsm_long_counter_clear_t fsm_long_counter_clear = {0};
  int32_t ret = {0};
                               ...
                               uint8_t *val)
{
  ...
  if (ret == 0)
  {
    ret = asm330lhhx_read_reg(ctx, ASM330LHHX_FSM_OUTS1, val, 16);
  }
...
{
  asm330lhhx_emb_func_odr_cfg_b_t emb_func_odr_cfg_b = {0};
  int32_t ret = {0};
...
{
  asm330lhhx_emb_func_init_b_t emb_func_init_b = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_long_cnt_int_value_set(const stmdev_ctx_t *ctx,
                                          uint16_t val)
{
  uint8_t buff[2] = {0};
  int32_t ret = {0};
  ...
  buff[1] = (uint8_t)(val / 256U);
  buff[0] = (uint8_t)(val - (buff[1] * 256U));
  ret = asm330lhhx_ln_pg_write_byte(ctx, ASM330LHHX_FSM_LC_TIMEOUT_L,
                                    &buff[0]);
...
/**
  ...
  *
  */
int32_t asm330lhhx_long_cnt_int_value_get(const stmdev_ctx_t *ctx,
                                          uint16_t *val)
{
  uint8_t buff[2] = {0};
  int32_t ret = {0};

  ret = asm330lhhx_ln_pg_read_byte(ctx, ASM330LHHX_FSM_LC_TIMEOUT_L,
                                   &buff[0]);
...
/**
  ...
  *
  */
int32_t asm330lhhx_fsm_number_of_programs_set(const stmdev_ctx_t *ctx,
                                              uint8_t *val)
{
  int32_t ret = {0};

  ret = asm330lhhx_ln_pg_write_byte(ctx, ASM330LHHX_FSM_PROGRAMS, val);
...
/**
  ...
  *
  */
int32_t asm330lhhx_fsm_number_of_programs_get(const stmdev_ctx_t *ctx,
                                              uint8_t *val)
{
  int32_t ret = {0};

  ret = asm330lhhx_ln_pg_read_byte(ctx, ASM330LHHX_FSM_PROGRAMS, val);
...
/**
  ...
  *
  */
int32_t asm330lhhx_fsm_start_address_set(const stmdev_ctx_t *ctx,
                                         uint16_t val)
{
  uint8_t buff[2] = {0};
  int32_t ret = {0};
  ...
  buff[1] = (uint8_t)(val / 256U);
  buff[0] = (uint8_t)(val - (buff[1] * 256U));
  ret = asm330lhhx_ln_pg_write_byte(ctx, ASM330LHHX_FSM_START_ADD_L,
                                    &buff[0]);

  if (ret == 0)
  {
    ret = asm330lhhx_ln_pg_write_byte(ctx, ASM330LHHX_FSM_START_ADD_H,
                                      &buff[1]);
  }
...
/**
  ...
  *
  */
int32_t asm330lhhx_fsm_start_address_get(const stmdev_ctx_t *ctx,
                                         uint16_t *val)
{
  uint8_t buff[2] = {0};
  int32_t ret = {0};

  ret = asm330lhhx_ln_pg_read_byte(ctx, ASM330LHHX_FSM_START_ADD_L,
                                   &buff[0]);

  if (ret == 0)
  {
    ret = asm330lhhx_ln_pg_read_byte(ctx, ASM330LHHX_FSM_START_ADD_H,
                                     &buff[1]);
    if (ret == 0)
    {
      *val = (uint16_t)(((uint16_t)buff[1] << 8) + buff[0]);
...
{
  asm330lhhx_emb_func_en_b_t reg = {0};
  int32_t ret = {0};
...
{
  asm330lhhx_emb_func_odr_cfg_c_t reg = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_mlc_out_get(const stmdev_ctx_t *ctx, uint8_t *val)
{
  int32_t ret = {0};
  ...
  if (ret == 0)
  {
    ret = asm330lhhx_read_reg(ctx, ASM330LHHX_MLC0_SRC, val, 8);
  }
...
/**
  ...
  *
  */
int32_t asm330lhhx_mlc_mag_sensitivity_set(const stmdev_ctx_t *ctx,
                                           uint16_t val)
{
  uint8_t buff[2] = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_mlc_mag_sensitivity_get(const stmdev_ctx_t *ctx,
                                           uint16_t *val)
{
  uint8_t buff[2] = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhx_sh_read_data_raw_get(const stmdev_ctx_t *ctx, uint8_t *val,
                                        uint8_t len)
{
  int32_t ret = {0};
  ...
  if (ret == 0)
  {
    ret = asm330lhhx_read_reg(ctx, ASM330LHHX_SENSOR_HUB_1, val, len);
  }
                                   ...
                                   asm330lhhx_shub_pu_en_t *val)
{
  ...
  {
    case 0:
      *val = ASM330LHHX_INTERNAL_PULL_UP_OFF;
      break;

    case 1:
      *val = ASM330LHHX_INTERNAL_PULL_UP_ON;
      break;
...
/**
  ...
  *
  */
int32_t asm330lhhx_sh_pass_through_get(const stmdev_ctx_t *ctx,
                                       uint8_t *val)
{
  asm330lhhx_master_config_t master_config = {0};
  int32_t ret = {0};
...
{
  asm330lhhx_slv0_add_t slv0_add = {0};
  int32_t ret = {0};
  ...
  if (ret == 0)
  {
    slv0_add.slave0 = (uint8_t)(val->slv0_add >> 1) & 0x7FU;
    slv0_add.rw_0 = 0;
...
{
  asm330lhhx_slv1_config_t slv1_config = {0};
  asm330lhhx_slv1_add_t slv1_add = {0};
  int32_t ret = {0};
  ...
  if (ret == 0)
  {
    ...
    slv1_add.r_1 = 1;
    ret = asm330lhhx_write_reg(ctx, ASM330LHHX_SLV1_ADD,
                               (uint8_t *)&slv1_add, 1);
  }
...
{
  asm330lhhx_slv2_config_t slv2_config = {0};
  asm330lhhx_slv2_add_t slv2_add = {0};
  int32_t ret = {0};
...
{
  asm330lhhx_slv3_config_t slv3_config = {0};
  asm330lhhx_slv3_add_t slv3_add = {0};
  int32_t ret = {0};
                                 ...
                                 asm330lhhx_status_master_t *val)
{
  ...
  if (ret == 0)
  {
    ret = asm330lhhx_read_reg(ctx, ASM330LHHX_STATUS_MASTER,
                              (uint8_t *)val, 1);
  }
